...
#     #file_src_path
#     src_path = os.path.join(REJECTED_DOWNLOAD_PATH, des_file_type)
#     str_split = src_file_name.split('.')
#     new_file = str_split[0] + "." + des_file_type
#     download_path_link=''

#     print "new_file >>>>>>>>>>>>"
#     print REJECTED_DOWNLOAD_PATH
#     print des_file_type
#     print des_file_type
...
#     download_path_link = os.path.join(
#         REJECTED_DOWNLOAD_BASE_PATH, des_file_type, new_dst_file_name)


#     print "download_path_link >>>>>>>>>>>>"
#     print download_path_link
