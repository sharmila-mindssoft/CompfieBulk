...
bu_api_params = {
    ...
    'bu_le_name': {'type': 'STRING', 'length': 50, 'validation_method': is_alpha_numeric, 'is_optional': False},
    ...
    'bu_postal_code': {'type': 'INT', 'length': None, 'validation_method': is_numeric, 'is_optional': False},
