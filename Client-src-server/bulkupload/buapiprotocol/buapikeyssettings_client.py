...
def make_string_field(
        length=100, is_optional=False, validfun=allow_specialchar):
    return {
        "type": "STRING", "length": length,
        "validation_method": validfun, "is_optional": is_optional}
...
def make_vector_type_field(module, klass_name, is_optional=False):
    return {
        "type": "VECTOR_TYPE", "is_optional": is_optional,
        "module_name": module, "class_name": klass_name}


def make_vector_type_int(length=None, is_optional=False):
    return {
        "type": "VECTOR_TYPE_INT", "length": length,
        "is_optional": is_optional
    }


def make_vector_type_string(
        length=100, is_optional=False, validfun=allow_specialchar):
    return {
...
def make_vector_type_text(
        length=None, is_optional=False, validfun=allow_specialchar):
    return {
        "type": "VECTOR_TYPE_TEXT", "length": length,
        "is_optional": is_optional, "validation_method": validfun}
...
def make_enum_type(module, klass_name):
    return {
        "type": "ENUM_TYPE", "module_name": module, "class_name": klass_name}


def make_map_type(
        module, klass_name, validfun=is_numeric, is_optional=False):
    return {
        "type": "MAP_TYPE", "validation_method": validfun,
        "is_optional": is_optional, "module_name": module,
        "class_name": klass_name}


def make_map_type_vector_type(
        module, klass_name, length=50, validfun=allow_specialchar):
    return {
        "type": "MAP_TYPE_VECTOR_TYPE", "length": length,
        "validation_method": validfun, "is_optional": False,
        "module_name": module, "class_name": klass_name}


def make_map_type_vector_type_string(length=150, is_optional=False):
    return {
        "type": "MAP_TYPE_VECTOR_TYPE_STRING",
        "is_optional": is_optional, "length": length}
...
def make_record_type(module, klass_name):
    return {
        "type": "RECORD_TYPE", "module_name": module,
        "class_name": klass_name
    }
...
bu_api_params = {
    ...
    "bu_uploaded_documents": make_int_field(),
    ...
    "skip_duplicate": make_bool_field(),
    "duplicate_count": make_int_field(is_optional=True)
}
