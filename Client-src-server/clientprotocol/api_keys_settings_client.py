...
api_params = {
    ...
    "assignee_name": make_string_field(is_optional=True),
    "concurrence_person": make_int_field(is_optional=True),
    "concurrer_name": make_string_field(is_optional=True),
    "approval_person": make_int_field(is_optional=True),
    "approver_name": make_string_field(is_optional=True),
    ...
    "compliance_frequency": make_vector_type_field(module="clientreport", klass_name="ComplianceFrequency"),
