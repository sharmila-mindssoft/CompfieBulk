...
from common import (USERNAME, PASSWORD, GROUP_ID, DOMAIN_NAME,
	Int8, Text20, Text50, Text500, Text100, Bool,
	USER_ID, COMPLIANCE_HISTORY_ID, DOMAIN_ID, INDUSTRY_ID,
	COUNTRY_ID, COUNTRY_NAME, SESSION_TOKEN, INDUSTRY_NAME,
	BUSINESS_GROUP_ID, BUSINESS_GROUP_NAME, LEGAL_ENTITY_ID,
	LEGAL_ENTITY_NAME, DIVISION_ID, DIVISION_NAME,
	UNIT_ID, UNIT_NAME, COMPLIANCE_ID, GROUP_NAME)

from core import Compliance, COMPLIANCE_FREQUENCY

__all__=  [
	"Request", "Response" ,"ApproveComplianceList",
	"SaveCompliance", "CONFIGURATION", "ComplianceApplicability",
...
MobileLogin = RecordType("MobileLogin", [
...
MobileLoginSuccess = RecordType("MobileLoginSuccess", [
	Field("user_id", USER_ID),
	Field("name", USERNAME),
	Field("session_token",  SESSION_TOKEN),
	Field("group_id", GROUP_ID),
	Field("group_name", GROUP_NAME),
	Field("configuration", VectorType(CONFIGURATION))
])
