...
var legalEntity = $("#business-group");
var legalEntityId = $("#business-group-id");
var acLegalEntity = $("#ac-business-group");

var domain = $("#legal-entity");
var domainId = $("#legal-entity-id");
var acDomain = $("#ac-legal-entity");

var unit = $("#division");
var unitId = $("#division-id");
var acUnit = $("#ac-division");

var act = $("#category");
var actId = $("#category-id");
var acAct = $("#ac-category");

var complianceTask = $("#domain");
var complianceTaskId = $("#domain-id");
var acComplianceTask = $("#ac-domain");
...
LegalEntityWiseReport.prototype.fetchDomainList = function(le_id) {
    t_this = this;
...
LegalEntityWiseReport.prototype.fetchUnitList = function(dom_id) {
    t_this = this;
...
LegalEntityWiseReport.prototype.fetchActList = function(unit_id) {
    t_this = this;
...
LegalEntityWiseReport.prototype.fetchComplianceaskList = function(act_id) {
    t_this = this;
