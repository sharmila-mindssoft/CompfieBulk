...
function validate_firsttab(){
  ...
  //   return false;
  // }else
  if ($('.legalentitylist.active').text() == ''){
  ...
  if(assignStatutoryLegalEntityId != null){
      ...
      for(var industryunit in unitsList){
        ...
        for(var unit in iUnits){
          //iUnits[unit]["business_group_id"] == assignStatutoryBusinessGroupId && iUnits[unit]["country_id"] == assignStatutoryCountryId
          if(iUnits[unit]["division_id"] == assignStatutoryDivisionId &&
