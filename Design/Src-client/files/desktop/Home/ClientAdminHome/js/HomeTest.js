$(document).ready(function() {
    ...
    $(".btn-country").click(function() {
        ...
        $(".btn-date-selection").removeClass("active");
        $(".textboxcountry").show();
        $(".textboxdomain").hide();
        $(".date-para1").hide();
    });
    ...
    $(".btn-date-selection").click(function() {
        $(".btn-country").removeClass("active");
        $(".btn-domain").removeClass("active");
        $(".btn-date-selection").addClass("active");
        $(".textboxcountry").hide();
        $(".textboxdomain").hide();
        $(".date-para1").show();
    });
    ...
    $(".btn-group").click(function() {
        ...
        $("#previousyear").show();
        $("#nextyear").show();
        if ($(".task-status-tab").hasClass("active")) {
            loadGroup();
        } else if ($(".ageing-tab").hasClass("active")) {
            ageingwiseCompliance()
        } else if ($(".compliance-tab").hasClass("active")) {
            loadPieChart()
        } else if ($(".esc-tab").hasClass("active")) {
            loadEscalations()
        } else if ($(".usecom-tab").hasClass("active")) {

        } else if ($(".trend-tab").hasClass("active")) {
            loadTrendChart()
        }
    })
    ...
    $(".btn-consolidate").click(function() {
        $(".btn-consolidate").addClass("active");
    });
    ...
    $(".ageing-tab").click(function() {
        $("#year-para").hide();
        $(".esc-tab").removeClass("active")
        $(".ageing-tab").addClass("active")
        $(".compliance-tab").removeClass("active")
        $(".task-status-tab").removeClass("active");
        $(".trend-tab").removeClass("active")
        $(".usecom-tab").removeClass("active")
...
function loadPieChart() {
    ...
    $(function() {
        ...
        $('#graph-5').highcharts({
            ...
            title: {
                text: 'Compliance Applicability Status ' + title
            },
            tooltip: {
                headerFormat: '',
