...
CREATE TABLE tbl_notifications_log (
  ...
  CONSTRAINT fk_units_nl_ap FOREIGN KEY (approval_person) REFERENCES tbl_units (unit_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT fk_units_nl_cp FOREIGN KEY (concurrence_person) REFERENCES tbl_units (unit_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)