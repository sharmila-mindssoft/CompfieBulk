window.Modernizr = function (e, t, n) {
  ...
  var f, d, p = '2.8.3', m = {}, h = !0, g = t.documentElement, v = 'modernizr', y = t.createElement(v), b = y.style, E = t.createElement('input'), w = ':)', x = {}.toString, S = ' -webkit- -moz- -o- -ms- '.split(' '), C = 'Webkit Moz O ms', k = C.split(' '), T = C.toLowerCase().split(' '), j = { svg: 'http://www.w3.org/2000/svg' }, N = {}, P = {}, M = {}, A = [], L = A.slice, $ = function (e, n, r, o) {
      ...
      return a = [
        ...
        e,
        '</style>'
      ].join(''), l.id = v, (u ? l : f).innerHTML += a, f.appendChild(l), u || (f.style.background = '', f.style.overflow = 'hidden', s = g.style.overflow, g.style.overflow = 'hidden', g.appendChild(f)), i = n(l, e), u ? l.parentNode.removeChild(l) : (f.parentNode.removeChild(f), g.style.overflow = s), !!i;
    }, z = function () {
      function e(e, o) {
  ...
  d = a(D, 'undefined') || a(D.call, 'undefined') ? function (e, t) {
    ...
    var n;
    return 'ontouchstart' in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : $([
      '@media (',
    ...
    try {
      (n = !!e.canPlayType) && (n = Boolean(n), n.ogg = e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, ''), n.h264 = e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/, ''), n.webm = e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, ''));
    } catch (r) {
    }
    return n;
  }, N.audio = function () {
    ...
    try {
      (n = !!e.canPlayType) && (n = Boolean(n), n.ogg = e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, ''), n.mp3 = e.canPlayType('audio/mpeg;').replace(/^no$/, ''), n.wav = e.canPlayType('audio/wav; codecs="1"').replace(/^no$/, ''), n.m4a = (e.canPlayType('audio/x-m4a;') || e.canPlayType('audio/aac;')).replace(/^no$/, ''));
    } catch (r) {
    }
    return n;
  ...
  d = function (e) {
    ...
    k.push(e);
  }, d.errorTimeout = 10000, null == t.readyState && t.addEventListener && (t.readyState = 'loading', t.addEventListener('DOMContentLoaded', f = function () {
