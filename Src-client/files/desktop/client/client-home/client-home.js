...
function showFiltersResults() {
  ...
  displayLoader();
  client_mirror.getAssigneewiseComplianes(parseInt(country), businessgroupid, legalentityid, divisionid, unitid, userid, function (status, data) {
...
$(document).ready(function () {
  ...
  client_mirror.getChartFilters(function (status, data) {
    ...
    toDict(BUSINESS_GROUPS, data.business_groups, 'business_group_id', 'business_group_name');
    toDict(LEGAL_ENTITIES, data.legal_entities, 'legal_entity_id', 'legal_entity_name');
