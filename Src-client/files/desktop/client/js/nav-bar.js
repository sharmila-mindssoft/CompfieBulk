...
function initializeNavBar() {
  ...
  if (menus.length == 0) {
    window.location.href = '/login' + window.localStorage.shortName;
  }
  ...
  if (employee_name == 'Administrator') {
  ...
  if (typeof client_name != 'undefined' && client_name != null) {
    ...
    client_mirror.getContractExpireAndNotificationCount();  /*setInterval(function() {
            get_notification_count();
        }, 1000000);*/
  }
}
