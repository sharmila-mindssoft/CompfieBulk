...
function ViewPage() {
    ...
    this.make_data_format = function(){
...
function pageControls() {
    ...
    AddComplianceButton.click(function(){
        ...
        if (Frequency.val() == 5) {
            ...
            statu = {};
            statu['statutory_date'] = $('.frequency-set #otstatutory_date').val();
            statu['statutory_month'] = $('.frequency-set #otstatutory_month').val();
            statu['trigger_before_days'] = $('.frequency-set #ottriggerbefore').val();
            statu['repeat_by'] = '';
            _renderinput.summary = "on " + $('.frequency-set #otstatutory_month option:selected').text() + statu['statutory_date'];
    ...
    SaveButton.click(function() {
        ...
        map_data = _viewPage.make_data_format();
