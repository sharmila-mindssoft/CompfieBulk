...
function loadFormListUpdate(clientunitId, businessgroupId, legalEntityId, divisionId){
    ...
    if(businessgroupId != ''){
       ...
       // $(".labelbusinessgroup").text(getBusinessGroupName(businessgroupId));
        $("#businessgroup-text").val(getBusinessGroupName(businessgroupId));
    ...
    if(divisionId != ''){
        ...
        $("#division-text").val(getDivisionName(divisionId));
                        ...
                        if(unitLocation == '' ){
                            ...
                            if(duplicates == ""){
                                ...
                                unit = mirror.getUnitDict(null, unitName, unitCode, unitAddress, parseInt(unitPostalCode),
                                    parseInt(unitGeographyId), unitLocation, parseInt(unitIndustryId), unitIndustryName, domainsVal);
                                units.push(unit);
                            }
                            else{
