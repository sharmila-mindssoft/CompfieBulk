...
function apipass(lastdate, todaydate, userid, formid, sno) {
  ...
  mirror.getAuditTrail(lastdate, todaydate, userid, formid, sno, function (error, response) {
    if (error == null) {
      onSuccess(response);
    } else {
      onFailure(error);
...
$('#pagination').click(function () {
  ...
  mirror.getAuditTrail(fromDateValue, toDateValue, userid, formid, sno, function (error, response) {
    if (error == null) {
      onSuccess(response);
    } else {
      onFailure(error);
