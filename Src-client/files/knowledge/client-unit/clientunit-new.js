...
function loadUnitValues(unitval) {
    ...
    //alert($('.domainselected-' + division_cnt + '-' + unit_second_cnt).html());
...
function addcountryrownew() {
    ...
    //alert($(clone).hasclass('multiselect-native-select'));
