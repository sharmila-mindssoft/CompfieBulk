...
def save_assigned_statutories(db, data, user_id):
    ...
    if submission_type == "Save" :
        if client_statutory_id is None:
            ...
            value_list = save_update_client_complainces(db, client_statutory_id, assigned_statutories, user_id, created_on)
            execute_bulk_insert(db, value_list)
    elif submission_type == "Submit" :
        assigned_statutories = data.assigned_statutories
        submit_client_statutories_compliances(db, client_statutory_id, assigned_statutories, user_id)
...
def save_update_client_complainces(db, client_statutory_id,  data, user_id, created_on):
...
def submit_client_statutories_compliances(db, client_statutory_id, data, user_id) :
