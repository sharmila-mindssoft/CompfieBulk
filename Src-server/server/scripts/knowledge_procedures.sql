...
-- To Save new categories from client unit form
-----------------------------------------------------------------------------------
...
ALTER TABLE `compfie_knowledge_updated`.`tbl_activity_log`
ADD COLUMN `user_category_id` INT(11) NOT NULL AFTER `created_on`;
