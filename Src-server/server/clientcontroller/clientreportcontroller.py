...
def process_client_report_requests(request, db) :
    ...
    if type(request) is clientreport.GetClientReportFilters:
        logger.logClientApi("GetClientReportFilters  - " + str(client_id), "process begin")
        ...
        logger.logClientApi("GetUnitwisecomplianceReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetAssigneewisecomplianceReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetServiceProviderReportFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetServiceProviderWiseCompliance  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetComplianceDetailsReportFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetComplianceDetailsReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetStatutoryNotificationsListFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetStatutoryNotificationsListReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetRiskReportFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetRiskReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetReassignedHistoryReportFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetReassignedHistoryReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetTaskApplicabilityStatusFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetComplianceTaskApplicabilityStatusReport  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetClientDetailsReportFilters  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("GetClientDetailsReportData  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
        ...
        logger.logClientApi("ExportToCSV  - " + str(client_id), "process begin")
        logger.logClientApi("------", str(time.time()))
