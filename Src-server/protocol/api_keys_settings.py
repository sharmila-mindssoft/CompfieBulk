...
api_params = {
    ...
    'repeat_by': {'type': 'STRING', 'length': 20, 'validation_method': is_alpha_numeric, 'is_optional': True},
    ...
    'c_by': {'type': 'INT', 'length': 10000, 'validation_method': None, 'is_optional': False},
    'c_on': {'type': 'TEXT', 'length': None, 'validation_method': None, 'is_optional': False},
    'u_by': {'type': 'INT', 'length': 10000, 'validation_method': None, 'is_optional': True},
    ...
    "assigned_statutories": {'type': 'VECTOR_TYPE', 'length': None, 'validation_method': None, 'is_optional': False, 'module_name': 'technotransactions', "class_name": "AssignedStatutories"},
    "unit_code_with_name": {'type': 'TEXT', 'length': 150, 'validation_method': None, 'is_optional': False},
    "submission_status": {'type': 'INT', 'length': 10000, 'validation_method': None, 'is_optional': True},
    ...
    "compfie_admin": {'type': 'TEXT', 'length': 500, 'validation_method': None, 'is_optional': False},
    "client_admin": {'type': 'TEXT', 'length': 500, 'validation_method': None, 'is_optional': False},
    "admin_update": {'type': 'TEXT', 'length': 500, 'validation_method': None, 'is_optional': False},
    "client_update": {'type': 'TEXT', 'length': 500, 'validation_method': None, 'is_optional': False},
