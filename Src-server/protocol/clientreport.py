...
class GetComplianceActivityReport(Request):
    def __init__(self, user_type, user_id, domain_id, statutory_id, unit_id, compliance_id, from_date, to_date):
    ...
    @staticmethod
    def parse_inner_structure(data):
        data = parse_dictionary(data, ["user_type", "user_id", "domain_id", "statutory_id", "unit_id", "compliance_id", "from_date", "to_date"])
...
class GetTaskApplicabilityStatusFiltersSuccess(Response):
    def __init__(self, countries, domains, business_groups, legal_entities, divisions, units, level_1_statutories):
        self.countries = countries
        self.domains = domains
        self.business_groups = business_groups
        self.legal_entities = legal_entities
    ...
    def parse_inner_structure(data):
        ...
        level_1_statutories = data.get("level_1_statutories")
        level_1_statutories = parse_structure_MapType_SignedIntegerType_8_MapType_SignedIntegerType_8_VectorType_RecordType_core_Statutory(level_1_statutories)
        return GetTaskApplicabilityStatusFiltersSuccess(countries, domains, business_groups, legal_entities, divisions, units, level_1_statutories)
...
class GetComplianceActivityReportFiltersSuccess(Response):
    def __init__(self, users, domains, level_1_statutories, units, compliances):
        self.users = users
        self.domains = domains
        self.level_1_statutories = level_1_statutories
        self.units = units
...
class GetStatutoryNotificationsListReportSuccess(Response):
    ...
    def parse_inner_structure(data):
        ...
        country_name = data.get("country_name")
        country_name = parse_structure_VectorType_CustomTextType_50(country_name)
        domain_name = data.get("domain_name")
        domain_name = parse_structure_VectorType_CustomTextType_50(domain_name)
        business_group_id = data.get("business_group_id")
    ...
    def to_inner_structure(self):
        print parse_structure_VectorType_CustomTextType_50
        print to_structure_VectorType_CustomTextType_50
        print to_structure_VectorType_RecordType_core_ClientBusinessGroup
        print to_structure_VectorType_RecordType_core_ClientLegalEntity
        print to_structure_VectorType_RecordType_core_ClientDivision
        print to_structure_VectorType_RecordType_core_ClientUnit
        print to_structure_VectorType_RecordType_core_ClientLevelOneStatutory
        return {
            "country_name": to_structure_VectorType_CustomTextType_50(self.country_name),
            "domain_name": to_structure_VectorType_CustomTextType_50(self.domain_name),
            "business_group_id": to_structure_VectorType_RecordType_core_ClientBusinessGroup(self.business_group_id),
            "legal_entity_id": to_structure_VectorType_RecordType_core_ClientLegalEntity(self.legal_entity_id),
            "division_id": to_structure_VectorType_RecordType_core_ClientDivision(self.division_id),
            "unit_id": to_structure_VectorType_RecordType_core_ClientUnit(self.unit_id),
            "level_1_statutory_id": to_structure_VectorType_RecordType_core_ClientLevelOneStatutory(self.level_1_statutory_id),
        }
...
class Activities(object):
    def __init__(self, unit_name, address, domain_wise_compliances):
        self.unit_name = unit_name
        self.address = address
        self.domain_wise_compliances = domain_wise_compliances

    @staticmethod
    def parse_structure(data):
        data = parse_dictionary(data, ["unit_name", "address", "domain_wise_compliances"])
        unit_name = data.get("unit_name")
        unit_name = parse_structure_CustomTextType_100(unit_name)
        address = data.get("address")
        address = parse_structure_CustomTextType_250(address)
        domain_wise_compliances = data.get("domain_wise_compliances")
        domain_wise_compliances = parse_structure_VectorType_RecordType_clientreport_DomainWiseCompliance(domain_wise_compliances)
        return Activities(unit_name, address, domain_wise_compliances)

    def to_structure(self):
        return {
            "unit_name": to_structure_CustomTextType_100(self.unit_name),
            "address": to_structure_CustomTextType_250(self.address),
            "domain_wise_compliances": to_structure_VectorType_RecordType_clientreport_DomainWiseCompliance(self.domain_wise_compliances),
        }
...
class ActivityCompliance(object):
    def __init__(self, compliance_name, activity_date, activity_status, compliance_status, remarks):
        self.compliance_name = compliance_name
    ...
    @staticmethod
    def parse_structure(data):
        data = parse_dictionary(data, ["compliance_name", "activity_date", "activity_status", "compliance_status", "remarks"])
        compliance_name = data.get("compliance_name")
        compliance_name = parse_structure_CustomTextType_100(compliance_name)
        ...
        remarks = data.get("remarks")
        remarks = parse_structure_CustomTextType_500(remarks)
        return ActivityCompliance(compliance_name, activity_date, activity_status, compliance_status, remarks)
